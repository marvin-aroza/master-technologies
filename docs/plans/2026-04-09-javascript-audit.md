...
| Security and Reliability | none | Very little beyond incidental strict-mode context | Build from scratch around XSS, CSRF, prototype pollution, safe DOM insertion, sanitization, and secure storage | Threat model, CSP, secure API usage, supply-chain concerns, origin/security boundaries, defense-in-depth guidance |
